...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sarkar Noor captures the quiet confidence of modern royalty—warm, refined, and impossible to ignore." },
      { name: "author", content: "Sarkar" },
      { property: "og:title", content: "Sarkar Noor — Warm Woody Floral Fragrance" },
      { property: "og:description", content: "Sarkar Noor captures the quiet confidence of modern royalty—warm, refined, and impossible to ignore." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@Sarkar" },
    ],
    links: [
      {
        rel: "stylesheet",
